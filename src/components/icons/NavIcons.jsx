export function BrandMarkIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      ...
      <path d="M7.8 7.2L11 16M16.2 7.2L13 16M8.2 6h7.6" />
    </svg>
  )
}
...
export function AutomationsIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M12.5 2.5L4 13.5h6.5L11 21.5l8.5-11H13l-0.5-8z" />
    </svg>
  )
}

export function ConnectorsIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M8.5 12a3.5 3.5 0 013.5-3.5h1a3.5 3.5 0 013.5 3.5v0a3.5 3.5 0 01-3.5 3.5H12" />
      <path d="M9 8.5V5.5M15 8.5V5.5M9 18.5v-3M15 18.5v-3" />
...
export function BellIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M18 8.5a6 6 0 10-12 0c0 5.5-2 7-2 7h16s-2-1.5-2-7" />
